...
public abstract class BigPipe implements Serializable, BigAlphabetCarrying
{
	private static Logger logger = MalletLogger.getLogger(BigPipe.class.getName());

	transient BigAlphabet dataAlphabet = null;
	transient BigAlphabet targetAlphabet = null;
	 ...
	 */
	public BigPipe (BigAlphabet dataDict, BigAlphabet targetDict)
	{
	...
	{
		return instancesFrom (new BigSingleInstanceIterator(inst));
	}
	...
	public void setDataAlphabet (BigAlphabet dDict)
	{
	...
	public void setOrCheckDataAlphabet (BigAlphabet a) {
	...
	public void setTargetAlphabet (BigAlphabet tDict)
	{
	...
	public void setOrCheckTargetAlphabet (BigAlphabet a) {
		if (targetAlphabet == null)
			targetAlphabet = a;
	...
	protected void preceedingPipeDataAlphabetNotification (BigAlphabet a)
	{
		if (dataAlphabet == null)
			dataAlphabet = a;
	}

	protected void preceedingPipeTargetAlphabetNotification (BigAlphabet a)
	{
		if (targetAlphabet == null)
			targetAlphabet = a;
	}
	...
	private class SimplePipeInstanceIterator implements Iterator<Instance>
	{
		...
		public BigPipe getPipe () { return null; }
	...
	private void readObject (ObjectInputStream in) throws IOException, ClassNotFoundException {
		...
		dataAlphabet = (BigAlphabet) in.readObject();
		targetAlphabet = (BigAlphabet) in.readObject();
