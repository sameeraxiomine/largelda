...
public class BigTokenSequenceRemoveStopwords extends BigPipe implements Serializable
{
	...
	public BigTokenSequenceRemoveStopwords (boolean caseSensitive, boolean markDeletions)
	{
	...
	public BigTokenSequenceRemoveStopwords (boolean caseSensitive)
	{
		stoplist = newDefaultStopList();
		this.caseSensitive = caseSensitive;
	}

	public BigTokenSequenceRemoveStopwords ()
	{
		this (false);
	}
	 ...
	 */
	public BigTokenSequenceRemoveStopwords(File stoplistFile, String encoding, boolean includeDefault,
	...
	public BigTokenSequenceRemoveStopwords setCaseSensitive (boolean flag)
	{
		this.caseSensitive = flag;
		return this;
	}

	public BigTokenSequenceRemoveStopwords setMarkDeletions (boolean flag)
	{
		this.markDeletions = flag;
		return this;
	}

	public BigTokenSequenceRemoveStopwords addStopWords (String[] words)
	{
	...
	public BigTokenSequenceRemoveStopwords removeStopWords (String[] words)
	{
		for (int i = 0; i < words.length; i++)
	...
	public BigTokenSequenceRemoveStopwords removeStopWords (File wordlist)
	{
	...
	public BigTokenSequenceRemoveStopwords addStopWords (File wordlist)
	{
		if (wordlist != null)
