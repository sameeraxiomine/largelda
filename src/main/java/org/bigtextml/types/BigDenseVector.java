...
public class BigDenseVector extends BigDenseMatrix implements Vector, Serializable
{

	public BigDenseVector (double[] values, boolean copy)
	{
		if (copy) {
	...
	public BigDenseVector (double[] values) { this (values, true); }

	public BigDenseVector (int size) { this (new double[size], false); }
	...
	public ConstantMatrix cloneMatrix () {
		return new BigDenseVector (values, true);
	}
