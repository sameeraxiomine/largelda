...
public class BigFeatureConjunction implements Serializable
{
	private static Logger logger = MalletLogger.getLogger(BigFeatureConjunction.class.getName());
	...
	public BigFeatureConjunction (String name, BigAlphabet dictionary,
	...
	public static String getName (BigAlphabet dictionary,
																int[] features, boolean[] negations)
	{
		if (true) { 
			if (negations != null)
	...
	// Always in "Alphabet index" order
	public static String getName (BigAlphabet dictionary, int[] features)
	{
		// Split apart any feature[i] that is itself a conjunction feature
		for (int i = 0; i < features.length; i++) {
	...
	public static boolean featuresOverlap (BigAlphabet dictionary,
	...
	public static int[] getFeatureIndices (BigAlphabet dictionary, String featureConjunctionName)
	{
	...
	public BigFeatureConjunction (BigAlphabet dictionary,
														 int[] features, boolean[] negations)
	{
	...
	public BigFeatureConjunction (BigAlphabet dictionary, int[] features)
	{
	...
	public boolean satisfiedBy (BigFeatureVector fv)
	{
	...
	public void addTo (BigAugmentableFeatureVector fv, double value, BigFeatureSelection fs)
	{
	...
	public void addTo (BigAugmentableFeatureVector fv, double value)
	{
		addTo (fv, value, null);
	}
	
	public void addTo (BigAugmentableFeatureVector fv)
	{
		this.addTo (fv, 1.0);
	}
	...
	public static class List implements Serializable
	{
		...
		public BigFeatureConjunction get (int i) { return (BigFeatureConjunction) conjunctions.get(i); }	

		public void add (BigFeatureConjunction fc)
		{
			if (conjunctions.size() > 0
					&& fc.dictionary != ((BigFeatureConjunction)conjunctions.get(0)).dictionary)
		...
		public void addTo (BigAugmentableFeatureVector fv, double value, BigFeatureSelection fs)
		{
			...
			for (int i = 0; i < conjunctions.size(); i++)
				((BigFeatureConjunction)conjunctions.get(i)).addTo (fv, value, fs);
		}
		...
		private void readObject (ObjectInputStream in) throws IOException, ClassNotFoundException {
			...
			if (size == NULL_INTEGER) conjunctions = null;
				...
				for (int i = 0; i < size; i++) {
					conjunctions.add((BigFeatureConjunction)in.readObject());
				}
			}
		}
	}
