...
public class BigTopicInferencer implements Serializable {
	...
	public BigTopicInferencer (int[][] typeTopicCounts, int[] tokensPerTopic, BigAlphabet alphabet,
	...
	public double[] getSampledDistribution(Instance instance, int numIterations,
		...
		throw new UnsupportedOperationException("Refactored");
	}
	
	public double[] getSampledDistribution(BigFeatureSequence tokens, int numIterations,
			   int thinning, int burnIn) {	
	...
	public static BigTopicInferencer read (File f) throws Exception {

        BigTopicInferencer inferencer = null;

		ObjectInputStream ois = new ObjectInputStream (new FileInputStream(f));
        inferencer = (BigTopicInferencer) ois.readObject();
		ois.close();
